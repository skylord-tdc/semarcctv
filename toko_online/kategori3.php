...
<body>
  <div class="page-holder">
    <!-- navbar-->
    <?php include 'source/navbar_kategori3.php'; ?>
      ...
      <section class="py-5 bg-light">
        <div class="container">
          <div class="row px-4 px-lg-5 py-lg-4 align-items-center">
            <div class="col-lg-6">
              <h1 class="h2 text-uppercase mb-0">accessories</h1>
            </div>
        ...
        <div class="container p-0">
          <div class="row">
            ...
            <div class="col-lg-3 order-2 order-lg-1">
              ...
              <div class="py-2 px-4 bg-dark text-white mb-3"><strong class="small text-uppercase fw-bold">accessories</strong></div>
              <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal">
                ...
                $no = 1;
                $dataKategori = mysqli_query($conn, "SELECT DISTINCT brand FROM produk WHERE kategori_produk = 'accessories' ");

                while ($dKategori = mysqli_fetch_array($dataKategori)) {
                ?>
                  <li class="mb-2"><a class="text-uppercase reset-anchor" href="kategori-accessories-filter?brand=<?php echo $dKategori['brand']; ?>"><?php echo $dKategori['brand']; ?></a></li>
                <?php } ?>
              </ul>
            ...
            <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
              ...
              <div class="row">
                ...
                // untuk pengulangan penomeran
                $no = 1;
                $dataShop = mysqli_query($conn, "SELECT * FROM produk WHERE kategori_produk = 'accessories' ");
