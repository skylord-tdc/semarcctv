      ...
      <section class="py-5 bg-light">
        <div class="container">
          <div class="row px-4 px-lg-5 py-lg-4 align-items-center">
            <div class="col-lg-6">
              <h1 class="h2 text-uppercase mb-0">Belanja</h1>
            </div>
        ...
        <div class="container p-0">
          <div class="row">
            ...
            <div class="col-lg-3 order-2 order-lg-1">
              ...
              <div class="py-2 px-4 bg-light mb-3"><strong class="small text-uppercase fw-bold">cctv indoor</strong></div>
              <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal">
                ...
                $no = 1;
                $dataKategori1 = mysqli_query($conn, "SELECT DISTINCT brand FROM produk WHERE kategori_produk = 'cctv indoor' ");

                while ($dKategori1 = mysqli_fetch_array($dataKategori1)) {
                ?>
                  <li class="mb-2"><a class="text-uppercase reset-anchor" href="belanja-filter?brand=<?php echo $dKategori1['brand']; ?>&kategori=cctv indoor"><?php echo $dKategori1['brand']; ?></a></li>
                <?php } ?>
              </ul>
              <div class="py-2 px-4 bg-light mb-3"><strong class="small text-uppercase fw-bold">cctv outdoor</strong></div>
              <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal">
                <?php
                // include 'koneksi/cf.php';
                ...
                // untuk pengulangan penomeran
                $no = 1;
                $dataKategori2 = mysqli_query($conn, "SELECT DISTINCT brand FROM produk WHERE kategori_produk = 'cctv outdoor' ");

                while ($dKategori2 = mysqli_fetch_array($dataKategori2)) {
                ?>
                  <li class="mb-2"><a class="text-uppercase reset-anchor" href="belanja-filter?brand=<?php echo $dKategori2['brand']; ?>&kategori=cctv outdoor"><?php echo $dKategori2['brand']; ?></a></li>
                <?php } ?>
              </ul>
              <div class="py-2 px-4 bg-light mb-3"><strong class="small text-uppercase fw-bold">aksesoris</strong></div>
              <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal mb-5">
                ...
                // untuk pengulangan penomeran
                $no = 1;
                $dataKategori3 = mysqli_query($conn, "SELECT DISTINCT brand FROM produk WHERE kategori_produk = 'accessories' ");

                while ($dKategori3 = mysqli_fetch_array($dataKategori3)) {
                ?>
                  <li class="mb-2"><a class="text-uppercase reset-anchor" href="belanja-filter?brand=<?php echo $dKategori3['brand']; ?>&kategori=accessories"><?php echo $dKategori3['brand']; ?></a></li>
            ...
            <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
              ...
              <div class="row">
                ...
                // untuk pengulangan penomeran
                $no = 1;
                $dataShop = mysqli_query($conn, "SELECT * FROM produk ORDER BY `id` DESC");
                          ...
                          <ul class="mb-0 list-inline">
                            <li class="list-inline-item m-0 p-0">
                              <form action="add-cart" method="post">
                                ...
                                <input type="hidden" name="produk_id" value="<?php echo $dShop['id']; ?>">
