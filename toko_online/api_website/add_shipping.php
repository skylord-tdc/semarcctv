...
if ($stok_habis) {
    ...
    $query = "INSERT INTO pesanan (nm_pelangan, email, tipe_layanan, bank, no_hp, alamat_tujuan, total_pembayaran, tanggal_pemesanan) VALUES ('$nm_pelangan', '$email', '$tipe_layanan', '$bank', '$no_hp', '$alamat',  '$total_pembayaran', '$date_now') ON DUPLICATE KEY UPDATE nm_pelangan=VALUES(nm_pelangan), email=VALUES(email), tipe_layanan=VALUES(tipe_layanan)";
