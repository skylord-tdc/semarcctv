...
$produk_id_1  = $_POST['produk_id_1'];

// Check if the product already exists in the cart table
$query_check = "SELECT * FROM cart WHERE produk_id = '$produk_id_1' AND user_id = '$user_id_1'";
...
$query_insert = "INSERT INTO cart (user_id, produk_id) VALUES ('$user_id_1', '$produk_id_1')";
