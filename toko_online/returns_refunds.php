...
<body>
    <div class="page-holder">
        ...
        <div class="container">
            ...
            <section class="py-5">
                <header>
                    <h2 class="h5 text-uppercase mb-4">Pengembalian Barang & Pengembalian Dana</h2>
                </header>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card text-dark bg-light mb-3" style="max-width: 100rem;">
                            <div class="card-header">Pengembalian Barang & Pengembalian Dana</div>
                            <div class="card-body">
                                <h5 class="card-title">Berikan bukti yang berkualitas</h5>
                                <p class="card-text">Setelah Anda mengajukan bantuan via WhatsApp, Anda memiliki waktu 1x24 jam untuk mengirimkan bukti pendukung, seperti foto/video produk saat unboxing dan nota penerimaan produk yang jelas.
                                    Jika bukti yang diberikan tidak jelas, Anda akan menerima pemberitahuan bahwa bukti tersebut tidak dapat diterima. Anda akan memiliki waktu tambahan sesuai yang ditentukan oleh tim SEMAR CCTV untuk memberikan bukti baru yang lebih jelas, atau Toko akan mengembalikan dana kepada Pembeli.</p>
                            </div>
                        </div>
