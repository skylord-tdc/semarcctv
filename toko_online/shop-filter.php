          ...
          <div class="row">
            ...
            <div class="col-lg-3 order-2 order-lg-1">
              ...
              <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal">
                ...
                ?>
                  <li class="mb-2"><a class="reset-anchor" href="belanja-filter?brand=<?php echo $dKategori1['brand']; ?>&kategori=cctv indoor"><?php echo $dKategori1['brand']; ?></a></li>
                <?php } ?>
              </ul>
              ...
              <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal">
                ...
                ?>
                  <li class="mb-2"><a class="reset-anchor" href="belanja-filter?brand=<?php echo $dKategori2['brand']; ?>&kategori=cctv outdoor"><?php echo $dKategori2['brand']; ?></a></li>
                <?php } ?>
              </ul>
              ...
              <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal mb-5">
                ...
                ?>
                  <li class="mb-2"><a class="reset-anchor" href="belanja-filter?brand=<?php echo $dKategori3['brand']; ?>&kategori=accessories"><?php echo $dKategori3['brand']; ?></a></li>
            ...
            <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
              ...
              <div class="row">
                ...
                // untuk pengulangan penomeran
                $no = 1;
                $dataShop = mysqli_query($conn, "SELECT * FROM produk WHERE kategori_produk='$_GET[kategori]' AND brand ='$_GET[brand]' ");
